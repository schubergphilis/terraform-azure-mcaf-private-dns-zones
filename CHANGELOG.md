...
* fix: remove kubernetesconfiguration private dns zone (#10) @frank-m

#### 🚀 Features

* feature: Backwards compatible way of implementing support for resolution_policy on all the zones. (#11) @frank-m

**Full Changelog**: https://github.com/schubergphilis/terraform-azure-mcaf-private-dns-zones/compare/v0.3.2...v0.4.0
